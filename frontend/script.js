...
let userPool;
// Initialize userPool safely if AmazonCognitoIdentity exists
if (typeof AmazonCognitoIdentity !== 'undefined') {
...
window.submitSignup = function() {
    ...
    userPool.signUp(email, password, attributeList, null, function(err, result) {
        ...
        currentSignupEmail = cognitoUser.getUsername();
        
        // Transition to OTP step
        document.getElementById('auth-signup-step').style.display = 'none';
        document.getElementById('auth-tabs').style.display = 'none'; // hide tabs during verify
...
window.submitOTP = function() {
    ...
    const userData = { Username: currentSignupEmail, Pool: userPool };
...
/**
 * HELPER: Get valid Access Token (auto-refreshes using Refresh Token if needed)
 */
...
window.handleLogout = function() {
    ...
    localStorage.removeItem('accessToken'); // migration cleanup
    localStorage.removeItem('idToken');      // migration cleanup
